...
namespace SharprWowApi
{
    interface IApiClient
    {
        ...
        SharprWowApi.Models.Guild.GuildRoot GetGuild(string name, GuildOptions guildOptions);
        SharprWowApi.Models.Guild.GuildRoot GetGuild(string realm, string name, GuildOptions guildOptions);
        ...
        System.Threading.Tasks.Task<SharprWowApi.Models.Guild.GuildRoot> GetGuildAsync(string name, GuildOptions guildOptions);
        System.Threading.Tasks.Task<SharprWowApi.Models.Guild.GuildRoot> GetGuildAsync(string realm, string name, GuildOptions guildOptions);
